...
export default function IllustrationWorking() {
    return (
      <svg viewBox="-100 0 733 482" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="a" x1="0%" x2="00%" y1="50%" y2="50%">
        ...
        <g fill="none">
          ...
          <path
            ...
            fill="url(#u)"
          />
          <circle cx="255" cy="395" fill="#25233A" r="11" />
          <circle cx="253.5" cy="397.5" fill="#3F3D56" r="5.5" />
          <circle cx="210" cy="384" fill="#25233A" r="11" />
          <circle cx="207" cy="399" fill="#25233A" r="11" />
